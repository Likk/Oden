...
describe 'about Oden::Command::Dictionary#run' => sub {
    ...
    context 'message prefix `move`' => sub {
        # Negative testing
        context 'case message pattern is `move` only. no key, no value' => sub {
            before all => sub {
        ...
        context 'case message pattern is `move <key>` only. no value' => sub {
            before all => sub {
                my $receiver = Oden::Entity::CommunicationReceiver->new(
                    message  => 'move foo',
                    guild_id => 1,
        ...
        # Positive testing
        context 'case message pattern is `move <key> <value>`' => sub {
            before all => sub {
                my $receiver = Oden::Entity::CommunicationReceiver->new(
